var PushbotsPlugin = {
    ...
    initialize: function(appId) {
		...
		cordova.exec( this.success, this.fail, 'PushbotsPlugin', 'initializeWithAppId', '56502e33177959a40c8b4568' );
    },


    initializeAndroid: function(appId, sender_id) {
		if(this.isAndroid()){
			cordova.exec( this.success, this.fail, 'PushbotsPlugin', 'initializeWithAppIdAndSenderId', '56502e33177959a40c8b4568', '657184287151' );
		}
    },
